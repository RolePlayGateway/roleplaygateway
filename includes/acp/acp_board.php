...
// Begin : Temporary Shadow Topics
						'shadow_prune_enable'	=> array('lang' => 'SHADOW_PRUNE_ENABLE',		'validate' => 'int:0:999',	'type' => 'text:3:3', 'explain' => true, 'append' => ' ' . $user->lang['HOURS']),						
						'shadow_prune_time'		=> array('lang' => 'SHADOW_PRUNE_TIME',		'validate' => 'int:0',	'type' => 'text:12:12', 'explain' => false, 'append' => ' ' . $user->format_date($config['shadow_prune_time'])),
