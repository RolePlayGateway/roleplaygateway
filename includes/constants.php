...
define('PRS_VOTES_TABLE',			$table_prefix . 'prs_votes');
define('PRS_VOTES_CHI_TABLE',		$table_prefix . 'prs_votes_chi');
define('PRS_PENALTY_TABLE', 		$table_prefix . 'prs_penalty');
define('PRS_MODPOINTS_TABLE',		$table_prefix . 'prs_modpoints');
define('POST_STATS_TABLE',			$table_prefix . 'post_stats');
define('USER_STATS_TABLE',			$table_prefix . 'user_stats');
