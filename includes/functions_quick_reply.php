...
function quick_reply($topic_id, $forum_id, &$topic_data)
{
	...
	$qr_config = array(
		...
		'display_subject'	=> isset($config['evil_qr_display_subject']) ? $config['evil_qr_display_subject'] : false,
		// Shall the box be hidden on pageload?
		'hide_box'			=> isset($config['evil_qr_hide_box']) ? $config['evil_qr_hide_box'] : true,
