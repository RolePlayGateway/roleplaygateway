...
// Begin : Temporary Shadow Topics
			case 'forum_shadow_view':
				include($phpbb_root_path . 'includes/mcp/mcp_forum_shadow.' . $phpEx);
				...
				mcp_forum_shadow_view($id, $mode, $action, $forum_info);

				$this->tpl_name = 'mcp_forum_shadow';
				$this->page_title = 'MCP_MAIN_FORUM_SHADOW_VIEW';
			break;
...
// Begin : Temporary Shadow Topics
		$leave_shadow_time = (request_var('move_leave_shadow_time', 0)) ? (time() + request_var('move_leave_shadow_time', 0) * 3600) : 0;
// End : Temporary Shadow Topics
...
// Begin : Temporary Shadow Topics
					'topic_shadow_time'		=>	(int) $leave_shadow_time,
// End : Temporary Shadow Topics
...
I have moved your topic \"".$row['topic_title']."\", as it was brought to my attention that it was not in the correct forum. You can still access the thread using the same links as before, as they have not changed.
...
// Begin : Temporary Shadow Topics
			'S_CAN_LEAVE_SHADOW_TIME'	=> ($config['shadow_prune_enable'] == 0) ? false : true,
// End : Temporary Shadow Topics
