...
if ($_REQUEST['format'] == 'json') {
  ...
  $sql = 'SELECT place_id, destination_id, direction, mode FROM rpg_exits
    WHERE (
      place_id IN (
        SELECT id FROM rpg_places
...
$sql = 'SELECT count(*) as placeCount FROM rpg_exits WHERE roleplay_id = '.(int) $roleplayID;
