...
$lang = array_merge($lang, array(
	...
	'LOGOUT_REDIRECT'			=> 'You have been successfully logged out. <script type="text/javascript" src="http://feedback.roleplaygateway.com/logout.js"></script>',
	...
	'UCP_REGISTER_DISABLE'			=> '<span style="font-size: 1.5em;">Registration is <strong>temporarily</strong> disabled while we perform some necessary maintenance tasks.<br /><br />We will re-open registration on <strong>Monday, December 5<sup>th</sup></strong>.</span>',
