...
$lang['errorUserInUse'] = 'Someone else is already logged in using that username!';
$lang['errorBanned'] = 'You are currently kicked from the chat, but you may come back later and find that your kick has expired.';
$lang['errorMaxUsersLoggedIn'] = 'The chat has reached the maximum number of logged-in users.';
$lang['errorChatClosed'] = 'The chat is closed at the moment while we clean up and optimize it for the new server. Go outside and get some fresh air.';
