...
if (!$forum_id)
{
	$module->set_display('main', 'forum_shadow_view', false);
}
// End : Temporary Shadow Topics

if ($mode == '' || $mode == 'unapproved_topics' || $mode == 'unapproved_posts' || $mode == 'unclosed_roleplays' || $mode == 'unreviewed_roleplays' )
{
