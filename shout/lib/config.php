...
$config['sessionCookieDomain'] = ".roleplaygateway.com";
// If enabled, cookies must be sent over secure (SSL/TLS encrypted) connections:
$config['sessionCookieSecure'] = null;

// Default channelName used together with the defaultChannelID if no channel with this ID exists:
$config['defaultChannelName'] = "Gambit's Bar";
...
$config['guestUserPrefix'] = 'visitor_';
// Guest users should be distinguished by either a prefix or a suffix or both (no whitespace):
...
$config['chatBotName'] = '[NPC] Bartender';
...
$config['socketServerHost'] = 'roleplaygateway.com';
